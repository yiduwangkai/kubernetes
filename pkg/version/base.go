...
var (
	...
	gitMajor     string = "9999"             // major version, always numeric
	gitMinor     string = "9999.0+"          // minor version, numeric possibly followed by "+"
	gitVersion   string = "v9999.9999.0-dev" // version from git, output of $(git describe)
