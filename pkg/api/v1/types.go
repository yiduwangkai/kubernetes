...
type PersistentVolume struct {
	...
	ObjectMeta `json:"metadata,omitempty" description:"standard object metadata; see http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#metadata"`
...
type PersistentVolumeList struct {
	TypeMeta `json:",inline"`
	ListMeta `json:"metadata,omitempty" description:"standard list metadata; see http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#types-kinds"`
...
//
// http://releases.k8s.io/v9999.9999.0/docs/design/secrets.md
...
type PodStatusResult struct {
	...
	// to date.
	Status PodStatus `json:"status,omitempty" description:"most recently observed status of the pod; populated by the system, read-only; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type Pod struct {
	...
	Spec PodSpec `json:"spec,omitempty" description:"specification of the desired behavior of the pod; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
...
type PodTemplate struct {
	...
	Template PodTemplateSpec `json:"template,omitempty" description:"the template of the desired behavior of the pod; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}

// PodTemplateList is a list of PodTemplates.
type PodTemplateList struct {
	TypeMeta `json:",inline"`
	ListMeta `json:"metadata,omitempty" description:"standard list metadata; see http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#metadata"`
...
type ReplicationController struct {
	...
	Spec ReplicationControllerSpec `json:"spec,omitempty" description:"specification of the desired behavior of the replication controller; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`

	// Status is the current status of this replication controller. This data may be
	// out of date by some window of time.
	Status ReplicationControllerStatus `json:"status,omitempty" description:"most recently observed status of the replication controller; populated by the system, read-only; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type Service struct {
	...
	Spec ServiceSpec `json:"spec,omitempty" description:"specification of the desired behavior of the service; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`

	// Status represents the current status of a service.
	Status ServiceStatus `json:"status,omitempty" description:"most recently observed status of the service; populated by the system, read-only; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type NodeStatus struct {
	...
	// see http://releases.k8s.io/v9999.9999.0/docs/resources.md for more details.
	Capacity ResourceList `json:"capacity,omitempty" description:"compute resource capacity of the node; http://releases.k8s.io/v9999.9999.0/docs/resources.md"`
...
type Node struct {
	...
	Spec NodeSpec `json:"spec,omitempty" description:"specification of a node; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`

	// Status describes the current status of a Node
	Status NodeStatus `json:"status,omitempty" description:"most recently observed status of the node; populated by the system, read-only; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type Namespace struct {
	...
	Spec NamespaceSpec `json:"spec,omitempty" description:"spec defines the behavior of the Namespace; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`

	// Status describes the current status of a Namespace
	Status NamespaceStatus `json:"status,omitempty" description:"status describes the current status of a Namespace; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type ObjectReference struct {
	...
	ResourceVersion string    `json:"resourceVersion,omitempty" description:"specific resourceVersion to which this reference is made, if any: http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#concurrency-control-and-consistency"`
...
type Event struct {
	TypeMeta   `json:",inline"`
	ObjectMeta `json:"metadata" description:"standard object metadata; see http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#metadata"`
...
type LimitRange struct {
	...
	Spec LimitRangeSpec `json:"spec,omitempty" description:"spec defines the limits enforced; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type ResourceQuota struct {
	...
	Spec ResourceQuotaSpec `json:"spec,omitempty" description:"spec defines the desired quota; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`

	// Status defines the actual enforced quota and its current usage
	Status ResourceQuotaStatus `json:"status,omitempty" description:"status defines the actual enforced quota and current usage; http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#spec-and-status"`
}
...
type RangeAllocation struct {
	TypeMeta   `json:",inline"`
	ObjectMeta `json:"metadata,omitempty" description:"standard list metadata; see http://releases.k8s.io/v9999.9999.0/docs/api-conventions.md#metadata"`
